      ...
      testimonials: [
        {
          ...
          description: 'Estoy muy contento y motivo de pertener al Aguaverde. Cada semana intento que mis compañeros amen un poco más este deporte',
          social: {
              twitter: '',
              facebook: ''
          }
...
.testimonial-card ul.socials>li {
    align-items: center;
